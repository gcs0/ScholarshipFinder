# scholarship-submission Specification

## Purpose
Covers user submission of new scholarships (requests for scholarships not yet listed in the system) and the admin review and approval workflow that turns those submissions into `Scholarship` rows.
